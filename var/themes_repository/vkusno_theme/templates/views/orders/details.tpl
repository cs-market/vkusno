            ...
            <div id="content_general" class="{if $selected_section && $selected_section != "general"}hidden{/if}">
                ...
                {if $without_customer != "Y"}
                    ...
                    <div class="orders-customer">
                        <h3>{__("ip5_theme_addon.delivery_details")}</h3>
                        <div class="orders-customer_content">
                            {include file="views/profiles/components/profiles_info.tpl" user_data=$order_info location="I"}
                            <div class="ty-delivery_info">
                                {hook name="orders:totals_shipping"}{/hook}
                            </div>
                                    ...
                                    <td>
                                        <div class="clearfix">
                                            ...
                                            <div class="ty-overflow-hidden ty-orders-detail__table-description-wrapper">
                                                <div class="ty-orders-detail__table-description">
                                                    {if $product.is_accessible}<a href="{"products.view?product_id=`$product.product_id`"|fn_url}">{/if}
                                                ...
                                                <div class="ty-orders-detail__table-price">
                                                    <div class="ty-right">
...
{*                                                    </div>*}
                                    ...
                                    <td class="ty-center ty-quantity">
...
{*    <em class="ty-date">({$order_info.timestamp|date_format|truncate:6:false:"`$settings.Appearance.date_format`, `$settings.Appearance.time_format`"})</em>*}
