{** block-description:my_account_mobile **}

<div class="ip5_account_info_title">
    <div class="ty-account-info__title-img">
        <img src="{$self_images_dir}/user_pc.svg" alt="" />
    </div>
</div>

<div class="ip5_account_info_body hidden">

    <div class="ip5_account_top">
        <span class="ip5_close_btn vk-arrow_right"></span>
