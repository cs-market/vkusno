...
<div class="ty-product-filters__wrapper {if $is_selected_filters}active{/if}" data-ca-product-filters="wrapper" {if $is_selected_filters}data-ca-product-filters-status="active"{/if}>
{if $items}
...
{/foreach}
    ...
    {if $ajax_div_ids}
        <div class="ty-product-filters__tools ty-product-filters__buttons {if !$is_selected_filters}hidden{/if}" data-ca-product-filters="tools">
...
{*                }*}
                {__("ip5_theme_addon.reset_all")}
            </a>

            <div class="ip5_filter_close_btn">{__("save")}</div>
