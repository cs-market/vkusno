...
<div class="ty-calendar__block">
    <input type="text" id="alt_{$date_id}" name="{$date_name}" class="ty-calendar__input{if $date_meta} {$date_meta}{/if}" value="{if $date_val}{$date_val|date_format:"`$date_format`"}{/if}" {$extra} size="10" data-ca-calendar-delivery-auto-save-on-change="true" data-ca-calendar-delivery-field="{$date_name}"/>
    <div id="{$date_id}"></div>
