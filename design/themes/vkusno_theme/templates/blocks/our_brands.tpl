...
>
    {foreach from=$brands item="brand" name="for_brands"}
            {include file="common/image.tpl" assign="object_img" class="ty-grayscale" image_height=$block.properties.thumbnail_width images=$brand.image_pair no_ids=true lazy_load=true obj_id="scr_`$block.block_id`000`$brand.variant_id`"}
