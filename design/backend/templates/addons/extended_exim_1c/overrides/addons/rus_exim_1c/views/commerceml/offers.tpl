...
{capture name="buttons"}
    {include file="buttons/button.tpl" but_text=__("save") but_name="dispatch[commerceml.sd_save_offers_data]" but_role="submit-link" but_target_form="offers_update_form"}
{/capture}
