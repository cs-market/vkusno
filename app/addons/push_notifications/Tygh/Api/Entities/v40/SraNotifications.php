...
class SraNotifications extends ASraEntity
{
    ...
    public function create($params)
    {
        ...
        foreach ($params as $param_name => &$param) {
            if (!$param) {
                if (in_array($param_name, array('app_version', 'app_name'))) {
                    $param = '';
                } else {
                    $is_valid = false;
    ...
    {
        return fn_push_notifications_app_update_notification_subscription(
            $this->auth['user_id'],
            $params
        );
    }
    ...
    protected function buildSubscriptionDetails(array $params)
    {
        $params = array(
            ...
            'app_name'  => $this->safeGet($params, 'app_name', null),
            'app_version'   => $this->safeGet($params, 'app_version', null),
        );
